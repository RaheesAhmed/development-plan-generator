...
const Chat = () => {
  ...
  const sendMessage = async (text: string) => {
    if (!threadId) {
      console.error("Thread ID not initialized");
      return;
    }
  ...
  const toolCallCreated = (toolCall: CodeInterpreterToolCall) => {
    if (toolCall.type !== "code_interpreter") return;
    appendMessage("code", "");
  };

  // toolCallDelta - log delta and snapshot for the tool call
  const toolCallDelta = (delta: CodeInterpreterToolCall, snapshot: any) => {
    ...
    <div className={styles.chatContainer}>
      ...
      >
        <input
          ...
          placeholder={
            inputDisabled ? "Initializing..." : "Enter your question"
          }
